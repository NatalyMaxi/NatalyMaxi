...
С августа 2023 и по настоящий день являюсь frontend-разработчком компании [Сектор бизнеса](https://sector.business/).
В мои обязанности входит:
- разработка новых приложений
- рефакторинг и обновление зависимостей старых приложений 
- дополнение нового функционала в ранее написанные приложения.
...
:checkered_flag: Я открыта к предложениям на позицию frontend-разработчика, где могу внести свой вклад и развиваться вместе с компанией. Если у вас есть вакансия, которая соответствует моим навыкам и опыту, буду рада сотрудничеству.
